...
const Navbar = () => {
  return (
    <div className='bg-[#A8A1BA] rounded-3xl py-1 px-2 flex items-center'>
        <Link href='/' className='text-[#14141B] cursor-pointer font-semibold font-sat tracking-tight text-[15px] py-2 px-4 ml-2'>
            HOW GHOTIP WORKS
        </Link>
        <Link href={'/docs'} className='text-[#14141B] cursor-pointer font-semibold font-sat tracking-tight text-[15px] py-2 px-4 ml-2'>
            DEV DOCS
        </Link>
